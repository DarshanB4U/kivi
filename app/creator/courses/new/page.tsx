...
import { AICourseArchitect } from "@/components/creator/ai-course-architect";
...
export default function NewCoursePage() {
  ...
  // New state to hold generated modules (for later persistence)
  const [generatedModules, setGeneratedModules] = useState<any[]>([]);

  const handleAIApplied = (data: { title: string; description: string; modules: any[] }) => {
    setFormData({
      title: data.title,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch("/api/courses", {
        ...
        body: JSON.stringify({
          ...parsed,
          modules: generatedModules, // Include modules if they were generated by AI
        }),
      });
